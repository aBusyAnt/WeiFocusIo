...
使用trim可以去除前后的空白字符,然后使用addslashes进行控制符转义，addslashes可以转义单双引号、反斜杠(\)和NULL字符，所谓转义。
...
> * [为什么 PHP 应该使用 PDO 方式访问数据库](http://www.oschina.net/translate/why-you-should-be-using-phps-pdo-for-database-access)
